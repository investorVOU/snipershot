...
import * as KeyQuorumsAPI from "./key-quorums.mjs";
...
export declare namespace PolicyIntentRequestDetails {
    interface Body {
        /**
 ...
 * (delete)
 */
export type RuleIntentRequestDetails = RuleIntentCreateRequestDetails | RuleIntentUpdateRequestDetails | RuleIntentDeleteRequestDetails;
/**
...
export declare namespace TransferIntentResponse {
    /**
     * The original transfer request that would be sent to the wallet transfer endpoint
     */
    interface RequestDetails {
 ...
 */
export type IntentResponse = RpcIntentResponse | TransferIntentResponse | WalletIntentResponse | PolicyIntentResponse | RuleIntentResponse | KeyQuorumIntentResponse;
/**
