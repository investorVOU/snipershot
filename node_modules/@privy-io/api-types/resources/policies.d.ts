...
export declare class Policies extends APIResource {
     ...
     * ```
     */
    _createRule(policyID: string, params: PolicyCreateRuleParams, options?: RequestOptions): APIPromise<PolicyRuleResponse>;
    /**
     ...
     * ```
     */
    _delete(policyID: string, params?: PolicyDeleteParams | null | undefined, options?: RequestOptions): APIPromise<SharedAPI.SuccessResponse>;
    /**
     ...
     * ```
     */
    _deleteRule(ruleID: string, params: PolicyDeleteRuleParams, options?: RequestOptions): APIPromise<SharedAPI.SuccessResponse>;
    /**
     ...
     * ```
     */
    _updateRule(ruleID: string, params: PolicyUpdateRuleParams, options?: RequestOptions): APIPromise<PolicyRuleResponse>;
    /**
     ...
     * ```
     */
    getRule(ruleID: string, params: PolicyGetRuleParams, options?: RequestOptions): APIPromise<PolicyRuleResponse>;
}
/**
...
export declare namespace AbiSchema {
    interface AbiSchemaItem {
 ...
 */
export type PolicyCondition = PolicyCondition.EthereumTransactionCondition | PolicyCondition.EthereumCalldataCondition | PolicyCondition.EthereumTypedDataDomainCondition | PolicyCondition.EthereumTypedDataMessageCondition | PolicyCondition.Ethereum7702AuthorizationCondition | PolicyCondition.SolanaProgramInstructionCondition | PolicyCondition.SolanaSystemProgramInstructionCondition | PolicyCondition.SolanaTokenProgramInstructionCondition | PolicyCondition.SystemCondition | TronTransactionCondition | TronCalldataCondition | SuiTransactionCommandCondition | SuiTransferObjectsCommandCondition | AggregationCondition;
 ...
 */
export type PolicyMethod = 'eth_sendTransaction' | 'eth_signTransaction' | 'eth_signUserOperation' | 'eth_signTypedData_v4' | 'eth_sign7702Authorization' | 'wallet_sendCalls' | 'signTransaction' | 'signAndSendTransaction' | 'exportPrivateKey' | 'exportSeedPhrase' | 'signTransactionBytes' | '*';
/**
