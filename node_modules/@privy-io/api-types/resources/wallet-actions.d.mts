...
export declare class WalletActions extends APIResource {
}
/**
 ...
 */
export type EvmWalletActionStepStatus = 'preparing' | 'queued' | 'pending' | 'retrying' | 'confirmed' | 'rejected' | 'reverted' | 'replaced' | 'abandoned';
/**
