...
export declare class Wallets extends APIResource {
     ...
     * ```
     */
    _rawSign(walletID: string, params: WalletRawSignParams, options?: RequestOptions): APIPromise<RawSignResponse>;
    /**
 ...
 */
export type TypedDataDomainInputParams = {
    [key: string]: unknown;
};
/**
 ...
 */
export type TypedDataTypesInputParams = {
    [key: string]: Array<TypedDataTypeFieldInput>;
};
/**
 ...
 */
export type EthereumRpcInput = EthereumSignTransactionRpcInput | EthereumSendTransactionRpcInput | EthereumPersonalSignRpcInput | EthereumSignTypedDataRpcInput | EthereumSecp256k1SignRpcInput | EthereumSign7702AuthorizationRpcInput | EthereumSignUserOperationRpcInput | EthereumSendCallsRpcInput;
/**
 ...
 */
export type EthereumRpcResponse = EthereumPersonalSignRpcResponse | EthereumSignTypedDataRpcResponse | EthereumSignTransactionRpcResponse | EthereumSendTransactionRpcResponse | EthereumSignUserOperationRpcResponse | EthereumSign7702AuthorizationRpcResponse | EthereumSecp256k1SignRpcResponse | EthereumSendCallsRpcResponse;
/**
 ...
 */
export type SolanaRpcInput = SolanaSignTransactionRpcInput | SolanaSignAndSendTransactionRpcInput | SolanaSignMessageRpcInput;
/**
 ...
 */
export type SolanaRpcResponse = SolanaSignMessageRpcResponse | SolanaSignTransactionRpcResponse | SolanaSignAndSendTransactionRpcResponse;
/**
 * The Spark network.
 */
 ...
 */
export type SparkRpcInput = SparkTransferRpcInput | SparkGetBalanceRpcInput | SparkTransferTokensRpcInput | SparkGetStaticDepositAddressRpcInput | SparkGetClaimStaticDepositQuoteRpcInput | SparkClaimStaticDepositRpcInput | SparkCreateLightningInvoiceRpcInput | SparkPayLightningInvoiceRpcInput | SparkSignMessageWithIdentityKeyRpcInput;
/**
 ...
 */
export type SparkRpcResponse = SparkTransferRpcResponse | SparkGetBalanceRpcResponse | SparkTransferTokensRpcResponse | SparkGetStaticDepositAddressRpcResponse | SparkGetClaimStaticDepositQuoteRpcResponse | SparkClaimStaticDepositRpcResponse | SparkCreateLightningInvoiceRpcResponse | SparkPayLightningInvoiceRpcResponse | SparkSignMessageWithIdentityKeyRpcResponse;
/**
 ...
 */
export type WalletRpcRequestBody = EthereumSignTransactionRpcInput | EthereumSendTransactionRpcInput | EthereumPersonalSignRpcInput | EthereumSignTypedDataRpcInput | EthereumSecp256k1SignRpcInput | EthereumSign7702AuthorizationRpcInput | EthereumSignUserOperationRpcInput | EthereumSendCallsRpcInput | SolanaSignTransactionRpcInput | SolanaSignAndSendTransactionRpcInput | SolanaSignMessageRpcInput | SparkTransferRpcInput | SparkGetBalanceRpcInput | SparkTransferTokensRpcInput | SparkGetStaticDepositAddressRpcInput | SparkGetClaimStaticDepositQuoteRpcInput | SparkClaimStaticDepositRpcInput | SparkCreateLightningInvoiceRpcInput | SparkPayLightningInvoiceRpcInput | SparkSignMessageWithIdentityKeyRpcInput | ExportPrivateKeyRpcInput | ExportSeedPhraseRpcInput;
/**
 * Response body for wallet RPC operations, discriminated by method.
 */
export type WalletRpcResponse = EthereumPersonalSignRpcResponse | EthereumSignTypedDataRpcResponse | EthereumSignTransactionRpcResponse | EthereumSendTransactionRpcResponse | EthereumSignUserOperationRpcResponse | EthereumSign7702AuthorizationRpcResponse | EthereumSecp256k1SignRpcResponse | EthereumSendCallsRpcResponse | SolanaSignMessageRpcResponse | SolanaSignTransactionRpcResponse | SolanaSignAndSendTransactionRpcResponse | SparkTransferRpcResponse | SparkGetBalanceRpcResponse | SparkTransferTokensRpcResponse | SparkGetStaticDepositAddressRpcResponse | SparkGetClaimStaticDepositQuoteRpcResponse | SparkClaimStaticDepositRpcResponse | SparkCreateLightningInvoiceRpcResponse | SparkPayLightningInvoiceRpcResponse | SparkSignMessageWithIdentityKeyRpcResponse | ExportPrivateKeyRpcResponse | ExportSeedPhraseRpcResponse;
/**
...
export declare namespace WalletRpcParams {
    ...
    interface EthereumSendCallsRpcInput {
        /**
         * Body param: A valid CAIP-2 chain ID (e.g. 'eip155:1').
         */
        caip2: AppsAPI.Caip2;
    ...
    interface SparkTransferRpcInput {
        /**
         * Body param
         */
        method: 'transfer';
    ...
    interface SparkGetBalanceRpcInput {
        /**
         * Body param
         */
        method: 'getBalance';
    ...
    interface SparkTransferTokensRpcInput {
        /**
         * Body param
         */
        method: 'transferTokens';
    ...
    interface SparkGetStaticDepositAddressRpcInput {
        /**
         * Body param
         */
        method: 'getStaticDepositAddress';
    ...
    interface SparkGetClaimStaticDepositQuoteRpcInput {
        /**
         * Body param
         */
        method: 'getClaimStaticDepositQuote';
    ...
    interface SparkClaimStaticDepositRpcInput {
        /**
         * Body param
         */
        method: 'claimStaticDeposit';
    ...
    interface SparkCreateLightningInvoiceRpcInput {
        /**
         * Body param
         */
        method: 'createLightningInvoice';
    ...
    interface SparkPayLightningInvoiceRpcInput {
        /**
         * Body param
         */
        method: 'payLightningInvoice';
    ...
    interface SparkSignMessageWithIdentityKeyRpcInput {
        /**
         * Body param
         */
        method: 'signMessageWithIdentityKey';
    ...
    interface ExportPrivateKeyRpcInput {
        /**
         * Body param
         */
        address: string;
    ...
    interface ExportSeedPhraseRpcInput {
        /**
         * Body param
         */
        address: string;
